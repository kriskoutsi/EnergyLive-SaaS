...
const directoryPath = '../AGPT_final'
                ...
                sleep(5000, function() {
                    ...
                    for (let i in data) { // SPLIT COLUMNS
                        ...
                        if (data[i][3] == 'CTY') {
                            ...
                            const actualGenerationOutput = data[i][7];
                            const productionType = data[i][6];
                            const event = { dateTime, actualGenerationOutput, productionType};
